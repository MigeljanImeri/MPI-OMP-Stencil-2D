...
int BLOCK_SIZE_HALO(int id, int p, int n);
...
void exchange_row_striped_matrix_halo(void**, MPI_Datatype, int, int, MPI_Comm );
...
void print_replicated_vector (void *, MPI_Datatype, int,
        MPI_Comm);
void write_row_striped_matrix(char* ,void **, MPI_Datatype, int,
	int, MPI_Comm);
void read_row_striped_matrix_halo (char *, void ***, void **,
        MPI_Datatype, int *, int *, MPI_Comm);
void print_row_striped_matrix_halo (void **, MPI_Datatype, int,
        int, MPI_Comm);
void write_row_striped_matrix_halo (char*, void **, MPI_Datatype, int,
        int, MPI_Comm);
void write_row_striped_matrix_halo_stack (FILE**, void **, MPI_Datatype, int,
        int, MPI_Comm);
